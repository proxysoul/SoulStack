...
| Layer list | `.layers`, `.layer-view` | Five layers tilted slightly back; the chosen one straightens and moves right. The detail panel lists what the layer does and ends with where it lands |
